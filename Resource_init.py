...
def load_model_resource():
    ...
    if xgb_model_raman is None:
        ...
        xgb_model_raman.load_model("model_xgb.json") # load model model_xgb.json from streamlit server 
        scale = joblib.load('scale.pkl') # load moel scale.pkl from streamlit server
        ann_model_process = load_model("network.h5") # load moel network.h5 from streamlit server
